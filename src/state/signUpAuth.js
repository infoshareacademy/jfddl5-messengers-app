...
export const onEmailSignUpChangeAction = value => ({type: EMAIL_SIGN_UP_CHANGE, email: value });

export const onPasswordSignUpChangeAction = value => ({ type: PASSWORD_SIGN_UP_CHANGE, password: value });

export const onEmptySignUpEmailClick = () => ({ type: EMPTY_SIGN_UP_EMAIL });

export const onEmptySignUpPasswordClick = () => ({ type: EMPTY_SIGN_UP_PASSWORD });
